...
def bootUpSequence():                                                    #Beim hochfahren sollen einmal alle farben RGB angezeigt werden. 
...
class RGBFunctions():
    global wheel, pulsing_light, strobe, bouncing_balls, snow_sparkle, rainbow, theaterChase, theaterChaseRainbow, rainbow
...
if __name__ == '__main__':                              #Hauptschleife zum init und abarbeiten der einzelnen Funktionen
    ...
    except KeyboardInterrupt:                   #Bei STRG C beendet der das Programm
        if args.clear:
            terminateSequence()

    except SystemExit:                         #Example
        terminateSequence()

    except	ConnectionError:                    #Wenn keine Verbindung aufgebaut werden kann Beende mit last function
