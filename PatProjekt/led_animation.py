...
LED_COUNT = 515       # Number of LED pixels. 515 Sind es Zeit auf 900s setzen
...
class GlobalMainFunction():                                                
    ...
    def colorWipe(strip, color, wait_ms=500):                             #Hauptfunktion
...
class RGBFunctions():
    global wheel, pulsing_light, strobe, bouncing_balls, snow_sparkle, rainbow, theaterChase, theaterChaseRainbow, rainbow, orangeWipe, yellowWipe, greenWipe, blueWipe, CyanWipe, PinkWipe

    def orangeWipe():
        colorWipe(strip, Color(255, 153, 51), 5)    # orange wipe
        time.sleep(900)
        colorWipe(strip, Color(0, 0, 0, 0), 5)      # Composite White + White LED wipe
    def yellowWipe():
        colorWipe(strip, Color(255, 255, 0), 5)     # yellow wipe
        time.sleep(900)
        colorWipe(strip, Color(0, 0, 0, 0), 5)      # Composite White + White LED wipe
    def greenWipe():
    ...
    def blueWipe():
        ...
        colorWipe(strip, Color(0, 0, 0, 0), 5)      # Composite White + White LED wipe    
    def CyanWipe():
        colorWipe(strip, Color(0, 255, 255), 5)     # Cyan wipe
        time.sleep(900)
        colorWipe(strip, Color(0, 0, 0, 0), 5)      # Composite White + White LED wipe
    def PinkWipe():
        colorWipe(strip, Color(255, 0, 255), 5)     # Pink Wipe
        time.sleep(900)
        colorWipe(strip, Color(0, 0, 0, 0), 5)      # Composite White + White LED wipe
