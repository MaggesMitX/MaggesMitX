...
class RGBFunctions():
    ...
    def orangeWipe():
        colorWipe(strip, Color(255, 153, 51), 10)    # orange wipe
        colorWipe(strip, Color(0, 0, 0, 0), 10)      # Composite White + White LED wipe
    def yellowWipe():
        colorWipe(strip, Color(255, 255, 0), 10)     # yellow wipe
        colorWipe(strip, Color(0, 0, 0, 0), 10)      # Composite White + White LED wipe
    def greenWipe():
    ...
    def blueWipe():
        ...
        colorWipe(strip, Color(0, 0, 0, 0), 10)      # Composite White + White LED wipe    
    def CyanWipe():
        colorWipe(strip, Color(0, 255, 255), 10)     # Cyan wipe
        colorWipe(strip, Color(0, 0, 0, 0), 10)      # Composite White + White LED wipe
    def PinkWipe():
        colorWipe(strip, Color(255, 0, 255), 10)     # Pink Wipe
        colorWipe(strip, Color(0, 0, 0, 0), 10)      # Composite White + White LED wipe
